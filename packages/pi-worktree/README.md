...
Relocate the active [pi](https://github.com/earendil-works/pi) session to a git worktree while preserving the full conversation history. When you create a new worktree and want to keep working there without losing context, this extension forks the session file, moves it to the new directory, and auto-continues.
